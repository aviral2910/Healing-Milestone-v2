...
class AppTheme {
  ...
  static ThemeData getThemeData(ThemePalette palette) {
    ...
    return (palette.isDark ? ThemeData.dark() : ThemeData.light()).copyWith(
      ...
      colorScheme: (palette.isDark ? const ColorScheme.dark() : const ColorScheme.light()).copyWith(
        primary: palette.accentPrimary,
        secondary: palette.accentSecondary,
        surface: palette.surface,
      ),
      dividerColor: palette.isDark ? const Color(0xFF2A2A2A) : const Color(0xFFE5E5EA),
      ...
      textTheme: baseTextTheme.copyWith(
        ...
        bodyLarge: baseTextTheme.bodyLarge?.copyWith(color: palette.textPrimary, height: 1.6),
        bodyMedium: baseTextTheme.bodyMedium?.copyWith(color: palette.textPrimary, height: 1.6),
        bodySmall: baseTextTheme.bodySmall?.copyWith(color: palette.textSecondary),
        titleLarge: baseTextTheme.titleLarge?.copyWith(color: palette.textPrimary, fontWeight: FontWeight.w800, letterSpacing: -0.5),
        titleMedium: baseTextTheme.titleMedium?.copyWith(color: palette.textPrimary, fontWeight: FontWeight.w700),
      ),
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(
            color: palette.isDark ? const Color(0xFF2A2A2A) : const Color(0xFFE5E5EA), 
            width: 1
          ), 
        ),
      ),

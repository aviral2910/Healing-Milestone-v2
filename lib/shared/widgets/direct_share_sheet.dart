...
class DirectShareOverlay extends ConsumerStatefulWidget {
  ...
  static Future<void> show(
    ...
    return showGeneralDialog(
      ...
      pageBuilder: (context, animation, secondaryAnimation) {
        return DirectShareOverlay(
          storyId: storyId,
          journeyId: journeyId,
          profileId: profileId,
          shareUrl: shareUrl,
          shareText: shareText,
          qrBottomText: qrBottomText,
        );
      },
  ...
  @override
  ConsumerState<DirectShareOverlay> createState() => _DirectShareOverlayState();
}

class _DirectShareOverlayState extends ConsumerState<DirectShareOverlay> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Full screen glassmorphism background like Journey Overlay
          BackdropFilter(

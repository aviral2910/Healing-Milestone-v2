        ...
        data: (journeys) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              return _PublicUserJourneyListItem(journey: journeys[index]);
            },
          );
        },
...
class _PublicUserJourneyListItem extends StatelessWidget {
  final JourneyModel journey;
  const _PublicUserJourneyListItem({required this.journey});

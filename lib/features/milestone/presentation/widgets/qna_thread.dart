...
class QnAThread extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final canReply =
        (currentUserId != null && currentUserId == milestone.authorId);
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(q['question']!,
                                    style: const TextStyle(
                                        color: Color(0xFFF5F5F7), height: 1.3)),
                              ],
                            ),
                          ),
                        ),
                      ...
                      Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle:
                                const TextStyle(color: Color(0xFFA1A1A6)),

...
# Add _buildShimmerBox outside of any class, or as a global helper, or in _MessageBubble
# Let's add it in _MessageBubble
old_msg_bubble_start = """class _MessageBubble extends ConsumerWidget {"""
new_msg_bubble_start = """class _MessageBubble extends ConsumerWidget {
...
"""
content = content.replace(old_msg_bubble_start, new_msg_bubble_start)
